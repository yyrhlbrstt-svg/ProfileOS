...
STANDARD_CHART: tuple[Account, ...] = (
    Account("1100", "בנק", AccountType.ASSET),
    Account("1200", "לקוחות (חייבים)", AccountType.ASSET),
    Account("1300", "מלאי — פרופילים", AccountType.ASSET),
    Account("1310", "מלאי — זכוכית", AccountType.ASSET),
    Account("1320", "מלאי — פרזול ומתכלים", AccountType.ASSET),
    Account("1400", "מע\"מ תשומות", AccountType.ASSET, "recoverable"),
    Account("1500", "עבודה בתהליך", AccountType.ASSET),
    Account("2100", "ספקים (זכאים)", AccountType.LIABILITY),
    Account("2150", "סחורה שהתקבלה טרם חשבונית", AccountType.LIABILITY),
    Account("2400", "מע\"מ עסקאות", AccountType.LIABILITY, "payable"),
    Account("3100", "הון", AccountType.EQUITY),
    Account("3900", "עודפים", AccountType.EQUITY),
    Account("4100", "מכירות — ייצור", AccountType.INCOME),
    Account("4900", "החזרות והנחות מכירה", AccountType.INCOME),
    Account("5100", "חומרים שנצרכו", AccountType.EXPENSE),
    Account("5200", "עבודה ישירה", AccountType.EXPENSE),
    Account("5300", "קבלני משנה", AccountType.EXPENSE),
    Account("5900", "סטיית מלאי", AccountType.EXPENSE),
    Account("6100", "שכר", AccountType.EXPENSE),
    Account("6200", "שכירות וארנונה", AccountType.EXPENSE),
    Account("6300", "ציוד ומתכלים", AccountType.EXPENSE),
    Account("6900", "תקורה אחרת", AccountType.EXPENSE),
)
